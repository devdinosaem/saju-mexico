    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 left-0 px-4 pt-3 pb-2 flex items-center gap-2 z-20">
          ...
          <span className="text-[14px] font-black tracking-[0.08em] uppercase" style={{ color: "#1a1a1a" }}>SAJUPLAY</span>
        </div>
    ...
    >
      ...
      <div className="relative shrink-0 flex items-center justify-center overflow-hidden" style={{ height: 268 }}>
        ...
        <div className="absolute top-3 left-4 flex items-center gap-2 z-20">
          <SajuTILogo className="w-6 h-6" />
          <span className="text-[14px] font-black tracking-widest" style={{ color: "rgba(255,255,255,0.55)" }}>SAJUPLAY</span>
        </div>
        <div className="absolute top-3 right-4 z-20">
          <span
            className="text-[10px] font-bold px-2 py-0.5 rounded-full"
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0 px-4 py-2.5 flex items-center justify-between" style={{ background: "#2D2D2D" }}>
        <span className="text-[10px] font-black tracking-[0.18em] text-white uppercase">SAJUPLAY MUSEUM</span>
      ...
      <div className="relative flex items-center justify-center overflow-hidden shrink-0" style={{ height: 232, background: celeb.domainBg }}>
        ...
        <div className="absolute bottom-2 left-3" style={{ opacity: 0.28 }}>
          <span className="text-[9px] font-black tracking-widest uppercase" style={{ color: celeb.domainColor }}>SAJUPLAY</span>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-1 px-4 pt-3 pb-4">
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          <span className="text-[9px] text-gray-300 font-bold tracking-widest">SAJUPLAY.COM</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0 flex items-center justify-between px-4 py-2">
        <span className="text-[10px] font-black tracking-[0.22em] uppercase" style={{ color: "rgba(255,255,255,0.65)" }}>SAJUPLAY</span>
