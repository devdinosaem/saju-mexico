...
function TileL({ children }: { children: ReactNode }) {
  return (
    <div className="bg-[#FDF6EE] rounded-2xl p-5 border-2 border-[#2D2D2D]/10 flex items-center justify-center">
      {children}
    </div>
  );
}
function TileD({ children }: { children: ReactNode }) {
  return (
    <div className="bg-[#2D2D2D] rounded-2xl p-5 flex items-center justify-center">
      {children}
    </div>
  );
}
...
export default function LogoPreview() {
  return (
    <main className="min-h-screen bg-[#FDF6EE] p-8">
      <h1 className="text-2xl font-bold text-center mb-2">SAJUPLAY 심볼 로고 시안</h1>
      <p className="text-sm text-center text-gray-500 mb-12">글씨 없는 심볼만</p>

      <div className="max-w-[700px] mx-auto space-y-16">

        {/* ════════════════ 신규: 사주플레이 로고 3유형 × [디테일/심볼] ════════════════ */}
        <div className="space-y-10 pb-10 border-b-2 border-[#2D2D2D]/10">
          <div className="text-center">
            <p className="text-lg font-extrabold text-[#2D2D2D]">★ 사주플레이 신규 시안</p>
            <p className="text-xs text-gray-400 mt-1">3유형 · 각 [디테일 / 심볼] · 라이트·다크</p>
          </div>

          {/* ─── 유형 1 — 플레이 ▶ ─── */}
          <div>
            <p className="text-sm font-bold text-[#2D2D2D] mb-0.5 text-center">유형 1 — 플레이 ▶</p>
            <p className="text-[11px] text-gray-400 mb-4 text-center">{"‘플레이’ 직관 · 앱 아이콘형"}</p>
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-[11px] text-gray-400 mb-2 text-center">디테일</p>
                <div className="grid grid-cols-2 gap-3">
                  <TileL>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <rect x="4" y="4" width="92" height="92" rx="28" fill="#FACC15" stroke="#2D2D2D" strokeWidth="3" />
                      <circle cx="50" cy="50" r="33" fill="#FDE68A" />
                      <path d="M40 30 L40 70 L74 50 Z" fill="#FFFFFF" stroke="#2D2D2D" strokeWidth="2.5" strokeLinejoin="round" />
                      <circle cx="47" cy="47" r="2.2" fill="#2D2D2D" />
                      <circle cx="55" cy="47" r="2.2" fill="#2D2D2D" />
                      <path d="M46 53 Q51 57 56 52" stroke="#2D2D2D" strokeWidth="1.8" fill="none" strokeLinecap="round" />
                      <ellipse cx="43" cy="51" rx="2.6" ry="1.4" fill="#E84B6A" opacity="0.3" />
                      <ellipse cx="59" cy="50" rx="2.6" ry="1.4" fill="#E84B6A" opacity="0.3" />
                      <path d="M78 18 L80 24 L86 26 L80 28 L78 34 L76 28 L70 26 L76 24 Z" fill="#E84B6A" />
                      <path d="M22 70 L23.5 75 L28 76 L23.5 77 L22 82 L20.5 77 L16 76 L20.5 75 Z" fill="#60A5FA" />
                    </svg>
                  </TileL>
                  <TileD>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
              ...
              <div>
                <p className="text-[11px] text-gray-400 mb-2 text-center">심볼</p>
                <div className="grid grid-cols-2 gap-3">
                  <TileL>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <circle cx="50" cy="50" r="42" fill="#E84B6A" stroke="#2D2D2D" strokeWidth="3" />
                      <path d="M40 32 L40 68 L70 50 Z" fill="#FFFFFF" stroke="#2D2D2D" strokeWidth="2.5" strokeLinejoin="round" />
                    </svg>
                  </TileL>
                  <TileD>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <circle cx="50" cy="50" r="42" fill="#E84B6A" stroke="#F5F5F5" strokeWidth="3" />
                      <path d="M40 32 L40 68 L70 50 Z" fill="#FFFFFF" stroke="#2D2D2D" strokeWidth="2.5" strokeLinejoin="round" />
                    </svg>
                  </TileD>
                </div>
          ...
          {/* ─── 유형 2 — 사주 카드 ─── */}
          <div>
            <p className="text-sm font-bold text-[#2D2D2D] mb-0.5 text-center">유형 2 — 사주 카드</p>
            <p className="text-[11px] text-gray-400 mb-4 text-center">{"‘카드 뽑기’ 컨셉 · 별·달 점성"}</p>
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-[11px] text-gray-400 mb-2 text-center">디테일</p>
                <div className="grid grid-cols-2 gap-3">
                  <TileL>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <rect x="26" y="24" width="34" height="56" rx="6" fill="#A78BFA" stroke="#2D2D2D" strokeWidth="2.5" transform="rotate(-13 43 52)" />
                      <rect x="36" y="18" width="36" height="62" rx="6" fill="#FFFFFF" stroke="#2D2D2D" strokeWidth="2.5" />
                      <rect x="40" y="22" width="28" height="54" rx="4" fill="none" stroke="#2D2D2D" strokeWidth="1" opacity="0.35" />
                      <path d="M54 30 L58 41 L70 41 L60 48 L64 60 L54 53 L44 60 L48 48 L38 41 L50 41 Z" fill="#FACC15" stroke="#2D2D2D" strokeWidth="1.8" strokeLinejoin="round" />
                      <circle cx="51" cy="44" r="1.5" fill="#2D2D2D" />
                      <circle cx="57" cy="44" r="1.5" fill="#2D2D2D" />
                      <path d="M51 49 Q54 52 57 49" stroke="#2D2D2D" strokeWidth="1.2" fill="none" strokeLinecap="round" />
                      <path d="M46 70 A6 6 0 1 1 41 62 A4.5 4.5 0 0 0 46 70Z" fill="#E84B6A" stroke="#2D2D2D" strokeWidth="1.2" />
                      <path d="M64 66 L65 69 L68 70 L65 71 L64 74 L63 71 L60 70 L63 69 Z" fill="#FACC15" />
                    </svg>
                  </TileL>
                  <TileD>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <rect x="26" y="24" width="34" height="56" rx="6" fill="#A78BFA" stroke="#F5F5F5" strokeWidth="2.5" transform="rotate(-13 43 52)" />
                      <rect x="36" y="18" width="36" height="62" rx="6" fill="#FFFFFF" stroke="#F5F5F5" strokeWidth="2.5" />
                      <rect x="40" y="22" width="28" height="54" rx="4" fill="none" stroke="#2D2D2D" strokeWidth="1" opacity="0.35" />
                      <path d="M54 30 L58 41 L70 41 L60 48 L64 60 L54 53 L44 60 L48 48 L38 41 L50 41 Z" fill="#FACC15" stroke="#2D2D2D" strokeWidth="1.8" strokeLinejoin="round" />
                      <circle cx="51" cy="44" r="1.5" fill="#2D2D2D" />
                      <circle cx="57" cy="44" r="1.5" fill="#2D2D2D" />
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <TileL>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <rect x="30" y="16" width="40" height="68" rx="9" fill="#FFFFFF" stroke="#2D2D2D" strokeWidth="3" />
                      <path d="M50 34 L54.5 46 L67 46 L57 54 L61 67 L50 59 L39 67 L43 54 L33 46 L45.5 46 Z" fill="#FACC15" stroke="#2D2D2D" strokeWidth="2" strokeLinejoin="round" />
                    </svg>
                  </TileL>
                  <TileD>
                    <svg viewBox="0 0 100 100" className="w-[84px] h-[84px]" fill="none">
                      <rect x="30" y="16" width="40" height="68" rx="9" fill="#FFFFFF" stroke="#F5F5F5" strokeWidth="3" />
                      <path d="M50 34 L54.5 46 L67 46 L57 54 L61 67 L50 59 L39 67 L43 54 L33 46 L45.5 46 Z" fill="#FACC15" stroke="#2D2D2D" strokeWidth="2" strokeLinejoin="round" />
                    </svg>
                  </TileD>
                </div>
          ...
          {/* ─── 유형 3 — 명태 ─── */}
          <div>
            <p className="text-sm font-bold text-[#2D2D2D] mb-0.5 text-center">유형 3 — 명태 🐟</p>
            <p className="text-[11px] text-gray-400 mb-4 text-center">액맞이 명태 마스코트</p>
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-[11px] text-gray-400 mb-2 text-center">디테일 (새끼줄)</p>
                <div className="grid grid-cols-2 gap-3">
                  <TileL>
                    <svg viewBox="0 0 112 80" className="w-[104px] h-auto" fill="none">
                      <path d="M88 40 L106 26 L100 40 L106 54 Z" fill="#FB923C" stroke="#2D2D2D" strokeWidth="2" strokeLinejoin="round" />
                      <path d="M14 40 Q22 18 50 18 Q80 18 92 40 Q80 62 50 62 Q22 62 14 40 Z" fill="#FDE68A" stroke="#2D2D2D" strokeWidth="2.5" strokeLinejoin="round" />
                      <path d="M44 19 Q52 7 64 20" fill="#FB923C" stroke="#2D2D2D" strokeWidth="1.8" strokeLinejoin="round" />
                      <path d="M42 61 Q48 71 58 60" fill="#FB923C" stroke="#2D2D2D" strokeWidth="1.8" strokeLinejoin="round" />
                      <path d="M40 44 Q34 54 47 51" fill="#FBBF24" stroke="#2D2D2D" strokeWidth="1.5" strokeLinejoin="round" />
                      <path d="M34 24 Q30 40 34 56" stroke="#2D2D2D" strokeWidth="1.5" fill="none" strokeLinecap="round" />
                      <path d="M40 32 Q58 29 84 36" stroke="#FB923C" strokeWidth="0.9" fill="none" opacity="0.5" />
                      <path d="M40 48 Q58 51 84 44" stroke="#FB923C" strokeWidth="0.9" fill="none" opacity="0.5" />
                      <path d="M64 23 L74 23 L74 57 L64 57 Z" fill="#F8FAFC" stroke="#CBD5E1" strokeWidth="1.5" strokeLinejoin="round" />
                      <path d="M64 27 L74 31" stroke="#CBD5E1" strokeWidth="1" />
                      <path d="M64 33 L74 37" stroke="#CBD5E1" strokeWidth="1" />
                      <path d="M64 39 L74 43" stroke="#CBD5E1" strokeWidth="1" />
                      <path d="M64 45 L74 49" stroke="#CBD5E1" strokeWidth="1" />
                      <path d="M64 51 L74 55" stroke="#CBD5E1" strokeWidth="1" />
                      <circle cx="27" cy="36" r="3.5" fill="#2D2D2D" />
                      <circle cx="28.2" cy="34.8" r="1.1" fill="#FFFFFF" />
                      <path d="M15 41 Q18 46 25 44" stroke="#2D2D2D" strokeWidth="1.5" fill="none" strokeLinecap="round" />
                      <ellipse cx="31" cy="44" rx="3" ry="1.6" fill="#E84B6A" opacity="0.3" />
                    </svg>
                  </TileL>
                  <TileD>
                    <svg viewBox="0 0 112 80" className="w-[104px] h-auto" fill="none">
                      <path d="M88 40 L106 26 L100 40 L106 54 Z" fill="#FB923C" stroke="#F5F5F5" strokeWidth="2" strokeLinejoin="round" />
                      <path d="M14 40 Q22 18 50 18 Q80 18 92 40 Q80 62 50 62 Q22 62 14 40 Z" fill="#FDE68A" stroke="#F5F5F5" strokeWidth="2.5" strokeLinejoin="round" />
                      <path d="M44 19 Q52 7 64 20" fill="#FB923C" stroke="#F5F5F5" strokeWidth="1.8" strokeLinejoin="round" />
                      <path d="M42 61 Q48 71 58 60" fill="#FB923C" stroke="#F5F5F5" strokeWidth="1.8" strokeLinejoin="round" />
                      <path d="M40 44 Q34 54 47 51" fill="#FBBF24" stroke="#F5F5F5" strokeWidth="1.5" strokeLinejoin="round" />
                      <path d="M34 24 Q30 40 34 56" stroke="#2D2D2D" strokeWidth="1.5" fill="none" strokeLinecap="round" />
                      <path d="M64 23 L74 23 L74 57 L64 57 Z" fill="#F8FAFC" stroke="#CBD5E1" strokeWidth="1.5" strokeLinejoin="round" />
                      <path d="M64 27 L74 31" stroke="#CBD5E1" strokeWidth="1" />
                      <path d="M64 33 L74 37" stroke="#CBD5E1" strokeWidth="1" />
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <TileL>
                    <svg viewBox="0 0 112 80" className="w-[104px] h-auto" fill="none">
                      <path d="M84 40 L104 26 L98 40 L104 54 Z" fill="#FACC15" stroke="#2D2D2D" strokeWidth="2.5" strokeLinejoin="round" />
                      <path d="M14 40 Q22 17 50 17 Q80 17 90 40 Q80 63 50 63 Q22 63 14 40 Z" fill="#FDE68A" stroke="#2D2D2D" strokeWidth="3" strokeLinejoin="round" />
                      <path d="M44 18 Q52 6 64 19" fill="#FACC15" stroke="#2D2D2D" strokeWidth="2.5" strokeLinejoin="round" />
                      <path d="M36 24 Q32 40 36 56" stroke="#2D2D2D" strokeWidth="2" fill="none" strokeLinecap="round" />
                      <circle cx="30" cy="36" r="3.2" fill="#2D2D2D" />
                      <path d="M15 41 Q18 46 25 44" stroke="#2D2D2D" strokeWidth="2" fill="none" strokeLinecap="round" />
                    </svg>
                  </TileL>
                  <TileD>
                    <svg viewBox="0 0 112 80" className="w-[104px] h-auto" fill="none">
                      <path d="M84 40 L104 26 L98 40 L104 54 Z" fill="#FACC15" stroke="#F5F5F5" strokeWidth="2.5" strokeLinejoin="round" />
                      <path d="M14 40 Q22 17 50 17 Q80 17 90 40 Q80 63 50 63 Q22 63 14 40 Z" fill="#FDE68A" stroke="#F5F5F5" strokeWidth="3" strokeLinejoin="round" />
                      <path d="M44 18 Q52 6 64 19" fill="#FACC15" stroke="#F5F5F5" strokeWidth="2.5" strokeLinejoin="round" />
                      <path d="M36 24 Q32 40 36 56" stroke="#2D2D2D" strokeWidth="2" fill="none" strokeLinecap="round" />
                      <circle cx="30" cy="36" r="3.2" fill="#2D2D2D" />
                      <path d="M15 41 Q18 46 25 44" stroke="#2D2D2D" strokeWidth="2" fill="none" strokeLinecap="round" />
                    </svg>
