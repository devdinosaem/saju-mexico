...
| --- | --- | --- | --- | --- |
| 전남친운·전여친운 / 엄마운·아빠운 상품 카드 (shop 4종) | `src/app/v3/shop/page.tsx` | `backlog/components/v3/shop/ExAndParentFortuneCards.tsx` | _(이 커밋)_ | shop 페이지 간소화. 연결 참조도 함께 제거: charge 가격표 `전남친·전여친운` 행 삭제·`올해운·부모운`→`올해운` 축소, my 보유샘플 `전남친운` 삭제. 상품 라인업 부활 시 복원 |
