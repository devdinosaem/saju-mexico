...
```
packages/
  manseryeok/    — 만세력 계산 엔진 (공유)
  saju-engine/   — 사주 해석 로직 (공유)
  saju-report/   — 리포트 생성 (공유, locale='kr'|'mx' 분기)
    src/locales/kr/ — 한국어 프롬프트/딕셔너리
    src/locales/mx/ — 스페인어 프롬프트/딕셔너리
  web/           — 🇲🇽 멕시코 Next.js 웹서비스 (포트 3000)
  web-kr/        — 🇰🇷 한국 Next.js 웹서비스 (포트 3001)
    /            — v1 랜딩 (두들/스티커 스타일)
    /v2          — v2 랜딩 (Spotify Wrapped 스타일)
