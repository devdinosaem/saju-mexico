...
2. **🚨 일주 ID에서 성별을 반드시 확인한다**: `-m` = 남성, `-f` = 여성. 이것을 먼저 메모하고 시작한다.
   ...
   - 예: "을묘-f" → 여성 → 4종 헤어 중 하나(긴머리/뿌까/양갈래/공주) + 선명한 볼터치
...
추가로 **얼굴 보조 디테일**(콧대 선·주근깨·수염·구레나룻·점)을 선택적으로 얹으면 "얼굴 밀도"를 확보할 수 있다.
...
```svg
<!-- 콧대 선 -->
<path d="M40 38 Q39 41 41 43" stroke="#2D2D2D" strokeWidth="0.8" fill="none" strokeLinecap="round" opacity="0.5"/>
...
**C. 양갈래 머리** (트윈테일 — 묶음머리 2갈래):
```svg
<!-- 상단 머리 -->
<path d="M22 30 Q22 10 40 8 Q58 10 58 30" fill="#92400E" stroke="#2D2D2D" strokeWidth="1.5"/>
<!-- 왼쪽 갈래 -->
<path d="M20 30 Q12 40 14 60 Q16 68 20 66 Q26 62 22 50 Q20 40 22 32 Z"
  fill="#92400E" stroke="#2D2D2D" strokeWidth="1.5"/>
<!-- 오른쪽 갈래 -->
<path d="M60 30 Q68 40 66 60 Q64 68 60 66 Q54 62 58 50 Q60 40 58 32 Z"
  fill="#92400E" stroke="#2D2D2D" strokeWidth="1.5"/>
<!-- 묶음 장식 -->
<circle cx="21" cy="30" r="3.5" fill="#F9A8D4" stroke="#2D2D2D" strokeWidth="1"/>
<circle cx="59" cy="30" r="3.5" fill="#F9A8D4" stroke="#2D2D2D" strokeWidth="1"/>
